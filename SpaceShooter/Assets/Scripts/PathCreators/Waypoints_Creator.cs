...
namespace Waypoints
{
    public class Waypoints_Creator : MonoBehaviour
    {
        ...
        {
            Waypoint waypointInstance = Instantiate(Resources.Load(ResourcesPath, typeof(Waypoint)),
                new Vector3(transform.position.x + 1, transform.position.y, transform.position.z), transform.rotation) as Waypoint;
        ...
        private void InitWaypoint(Waypoint waypointInstance, Transform nextTransform)
        {
            ...
            waypointInstance.transform.position += waypointInstance.transform.up;
        }
