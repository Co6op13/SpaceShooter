...
public class Waypoints_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        SerializedProperty speedMovemetntToPoint = serializedObject.FindProperty("speedMovemetntToPoint");
        EditorGUILayout.PropertyField(speedMovemetntToPoint, new GUIContent("speedMovemetntToPoint"), GUILayout.Height(20));
        self.SpeedMovemetntToPoint = speedMovemetntToPoint.floatValue;
